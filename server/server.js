...
const connectDB = async () => {
  try {
    ...
    console.warn('⚠️  Starting server without database. API features will be limited.');
  }
};
...
connectDB().then(() => {
  ...
  console.warn('Failed to connect to MongoDB, starting server without database.');
  startServer();
});
